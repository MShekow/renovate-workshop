# Renovate introduction workshop

This document contains the instructions for people who _do not_ join the mob session, but want to work on the tasks on their own, in a self-paced tempo.

## Preparation work

Before we start, we need to set up a copy of this repository under your GitHub organization, and grant the hosted Renovate GitHub app access to it:

- Open https://github.com/new/import to make a _copy_ of this repo (_forking_ this repo would work too, but it is less anonymous)
